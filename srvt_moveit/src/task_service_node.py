...
class TaskServiceClass():
    ...
    def multi_task_list_func(self):
        ...
        right_filter_list_1 = list([35269, 35270, 35271, 35272, 35273, 35274, 35275, 35276,
        35277, 35278, 35279, 35280, 35281, 35282, 35283, 35284, 35286, 35287, 35288, 35289,
        35290, 35291, 35292, 35293, 35294, 35295, 35296, 35297, 35298, 35299, 35300, 35301,
        35302, 35303, 35304, 35305, 35306, 35307, 35308, 35309, 35310, 35311, 35312, 35313,
        35314, 35315, 35316, 35317, 35318, 35319, 35320, 35321, 35322, 35323, 35324, 35325,
        35326, 35327, 35328, 35329, 35330, 35331, 35332, 35333, 35334, 35335, 35336, 35337,
    ...
    def filter_read_task(cls, read_task, filter_list):
        ...
        try:
            ...
            for _, item in enumerate(read_task):
                ...
                task_list = list([[position["X"], position["Y"], position["Z"], position["C_AX"],
                 position["C_AZ"]], [queue["X"], queue["Y"], queue["Z"], queue["C_AX"],
