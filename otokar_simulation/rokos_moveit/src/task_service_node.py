...
class TaskServiceClass(object):
    """
        left_rokos_task.yaml ve right_rokos_task.yaml dosyalarında görevlerin bilgilerini çeker.
        Daha sonra rokos_task.yaml dosyasında belirtilen görev ID' lerine göre filtreleme işlemi uygular.
        Smach' ten Task Service'e istek gelir ve filtrelenmiş görevleri Smach' e gönderir.
    """
    def __init__(self):
        ...
        self.right_rokos_task_list = list()
        self.left_rokos_task_list = list()

        # Parçalı görevlerde bu yapı kullanılır.
        self.right_rokos_multi_task_list = list()
        self.left_rokos_multi_task_list = list()
    ...
    def task_list_func(self):
        try:
            ...
            # rokos_task.yaml dosyasında belirtilen görev ID' leri yerine None yazılmış ise, tüm görevler gönderilir.
        ...
        print("\nRokos Right Task = {}\n".format(self.right_rokos_task_list))
        print("\nRokos Left  Task = {}\n".format(self.left_rokos_task_list))


    def multi_task_list_func(self):
        # 2 Parca
        right_filter_list_1 = list([35269, 35270, 35271, 35272, 35273, 35274, 35275, 35276, 35277, 35278, 35279, 35280, 35281, 35282, 35283, 35284, 35286, 35287, 35288, 35289, 35290, 35291, 35292, 35293, 35294, 35295, 35296, 35297, 35298, 35299, 35300, 35301, 35302, 35303, 35304, 35305, 35306, 35307, 35308, 35309, 35310, 35311, 35312, 35313, 35314, 35315, 35316, 35317, 35318, 35319, 35320, 35321, 35322, 35323, 35324, 35325, 35326, 35327, 35328, 35329, 35330, 35331, 35332, 35333, 35334, 35335, 35336, 35337, 35338, 35339, 35340, 35341, 35342, 35343, 35344, 35345, 35346, 35347, 35348, 35349, 35350])
        right_filter_list_2 = list([35351, 35352, 35353, 35354, 35355, 35356, 35357, 35358, 35359, 35360, 35361, 35362, 35363, 35364, 35365, 35366, 35367, 35368, 35369, 35370, 35371, 35372, 35373, 35374, 35375, 35376, 35377, 35378, 35379, 35380, 35381, 35382, 35385, 35386, 35387, 35388, 35389, 35390, 35391, 35392, 35393, 35394, 35395, 35396, 35397, 35398, 35399, 35400, 35401, 35402, 35403, 35404, 35405, 35406, 35407, 35408, 35409, 35410, 35411, 35412, 35413, 35414, 35415, 35416, 35417, 35418, 35419, 35420, 35421, 35422, 35423, 35424, 35425, 35426, 35427, 35428, 35429, 35430, 35431, 35432, 35433, 35434, 35435, 35436])

        left_filter_list_1 = list([35694, 35695, 35696, 35697, 35698, 35699, 35700, 35701, 35702, 35703, 35704, 35705, 35706, 35707, 35708, 35709, 35710, 35711, 35712, 35713, 35714, 35715, 35716, 35717, 35718, 35719, 35720, 35721, 35722, 35723, 35724, 35725, 35726, 35727, 35728, 35729, 35730, 35731, 35732, 35733, 35734, 35735, 35736, 35737, 35738, 35739, 35740, 35741, 35742, 35743, 35744, 35745, 35746, 35747, 35748, 35749, 35751, 35752, 35753, 35756, 35757, 35758, 35759, 35760, 35761, 35762, 35763, 35764, 35765, 35766, 35767, 35768, 35769, 35770, 35771, 35772, 35773, 35774, 35775, 35776, 35777, 35778, 35779, 35780, 35781, 35782, 35783])
        left_filter_list_2 = list([35784, 35785, 35786, 35787, 35788, 35789, 35790, 35791, 35792, 35793, 35794, 35795, 35796, 35797, 35798, 35799, 35800, 35801, 35802, 35803, 35804, 35805, 35806, 35807, 35808, 35809, 35810, 35811, 35812, 35813, 35814, 35815, 35816, 35817, 35818, 35819, 35820, 35821, 35822, 35823, 35824, 35825, 35826, 35827, 35828, 35829, 35830, 35831, 35832, 35833, 35834, 35835, 35836, 35837, 35838, 35839, 35840, 35841, 35842, 35843, 35844, 35845, 35846, 35847, 35848, 35849, 35850, 35851, 35852, 35853, 35854, 35855, 35858, 35859, 35860, 35861, 35862, 35863, 35864, 35865, 35866, 35867, 35868, 35869, 35870, 35871, 35872, 35873, 35874, 35875, 35876, 35877, 35878, 35879, 35880, 35881, 35882])
    ...
    def main_func(self):
        ...
        left_rokos_task_service = rospy.Service('left_rokos_task_service', TaskService, self.left_rokos_task_service_func)
        right_rokos_task_service = rospy.Service('right_rokos_task_service', TaskService, self.right_rokos_task_service_func)
    ...
    def right_rokos_task_service_func(self, request):
        try:
            ...
            # Örneğin 2 parça görevde, indis 0 ve indis 1 i sürekli olarak göndermesi için. 
    ...
    def filter_read_task(self, read_task, filter_list):
        """
            Tüm görevlenden(read_task), yapılması istenen görev IDlerine(filter_list) göre filtreleme işlemi burada gerçekleşir.
        """
        try:
            mission_list = list()
            """
            ...
            Not* = left_rokos_task.yaml ve right_rokos_task.yaml dosyalarında bulunan görevlerden filter_list'te yer alan IDlere göre görevlerin bilgilerini okur.
            ...
            for _, item in enumerate(read_task):
                ...
                task_list = list([[position["X"], position["Y"], position["Z"], position["C_AX"], position["C_AZ"]], 
                                    [queue["X"], queue["Y"], queue["Z"], queue["C_AX"], queue["C_AZ"]], 
                                    [task_id, str(vehicle_code), mode, str(tag)]])
