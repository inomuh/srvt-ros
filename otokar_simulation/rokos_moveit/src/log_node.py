...
class LogClass(object):
    def __init__(self, file_name, current_state):
        ...
        self.new_file_name = str(self.current_workspace) + 'rokos_moveit/log_file/' + str(self.current_time + "_" + self.file_name)
...
# ------------------------------------------------------------------------------------------------
    ...
    def yaml_write_func(self, write_data_list):
        ...
        with open(str(self.current_workspace) + 'rokos_moveit/log_file/'+ str(new_file_name) + '.yaml', 'w') as outfile:
